...
async def commit(_, message):
   await message.delete()  
    await message.reply_text((await random_line('Sehid/sehid.txt')), reply_markup=button, reply_markup=button)
...
async def deyis(_, query: CallbackQuery):
    await query.edit_message_text((await random_line('Sehid/sehid.txt')), reply_markup=button, reply_markup=button)