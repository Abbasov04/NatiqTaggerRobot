...
def btag():
	BUTTON=[[InlineKeyboardButton(text="Sahibim ⭐", url=f"https://t.me/{Config.OWNER_NAME}"),
InlineKeyboardButton(text="Sahibim ✨", url=rl=f"https://t.me/{Config.PLAYLIST_NAME}"),      InlineKeyboardButton(text="️Dayandır", callback_data="cancel"),],]
