...
db = MONGODB(Config.MONGODB_URI, Config.BOT_USERNAME)
...
# Broadcast komutu
@app.on_message(filters.command("broadcastall") & filters.user(OWNER_ID) & filters.reply)
