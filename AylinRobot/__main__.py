...
async def start(client, message):
    ...
    if FSub == 400:
        return
    await client.send_message(Config.LOG_CHANNEL, "🙋‍♀️ Yeni İstifadəçi:\n\n🙎‍♀️ Ad: {}\n[ling](https://t.me/{})\n🧟‍♀️ ID:`{}`\n\n💁‍♀️ Bot: [{Config.BOT_NAME}](https://t.me/{})")
    await message.reply_photo(
        AylinIMG,
        caption=Translation.START_TEXT.format(message.from_user.mention, Config.BOT_USERNAME,Config.OWNER_NAME, Config.BOT_NAME, message.from_user.id),
