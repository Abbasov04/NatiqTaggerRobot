...
GROUP_BAN = 
"""Üzgünüm, grubunuz karalisteye alındı! Burada daha fazla kalamam. Bunun bir hata olduğunu düşünyorsanız {} yazın.'"""
NOT_ONLINE = 
"""aktif değil"""
BOT_BLOCKED = 
"""botu engellemiş"""
USER_ID_FALSE = 
"""kullanıcı kimliği yanlış"""
BROADCAST_STARTED = 
"""```📤 BroadCast başlatıldı! Bittiği zaman mesaj alacaksınız!"""
BROADCAST_STOPPED = 
"""✅ ```Broadcast başarıyla tamamlandı.``` \n\n**Şu Kadar Sürede Tamamlandı:** `{}` \n\n**Kayıtlı Toplam Kullanıcı:** `{}` \n\n**Toplam Gönderme Denemesi:** `{}` \n\n**Başarıyla Gönderilen:** `{}` \n\n**Toplam Hata:** `{}`"""
STATS_STARTED = 
"""{} **Lütfen bekleyiniz verileri getiriyorum!**"""
STATS = 
