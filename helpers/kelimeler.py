import random
kelimeler = ['gözəl', 'bilik','problem', 'təmin', 'ayrılmaq', 'zaman','su','edin','istifadə','yox','bax', 'dərinizdən', 'çox', 'amma', 'lirə', 'oynamaq', 'çiçək', ,'şəhər', 'yüksək', 'döyüş', 'varlıq', 'domino', 'güvən', 'lazım', 'müalicə', 'vahid', 'rahat', 'soyuq', 'orada', 'kitab', 'pay', 'hesab', 'bədən', 'zəmin', 'aşdı', 'sistem', 'gözəl', 'çəkilmə', 'texnika', 'yanlaşma', 'il', 'tarix', 'dəqiq', 'bacı', 'cərimə', 'əgər', 'halbuki', 'qaytarmaq', 'vermək', 'var', 'qalıq', 'şəxs', 'başqa', 'dövr', 'yenidən', 'bunlar', 'kitab', 'hadisə', 'olmaq', 'sən', "dövlət", 'ön', 'çox', 'baxmaq', 'on', 'belə', 'bəzi', 'başlamaq', 'saxla', 'birini', 'biri', 'et', 'su', 'bəyən', 'dövlət', 'sağ', 'orta', 'başqa', 'böyük', 'etmək', 'yeni', 'daha', 'soruş', 'onlar', 'yandır', 'soru', 'ikisi', 'həmişə', 'səs', 'anla', 'yox', 'saat', 'necə', 'bir', 'və', 'olmaq', 'bu', 'üçün', 'bu', 'mən', 'demək', 'çox', 'edmək', 'nə', 'bəyənmək', ' daha ', 'almaq', 'var', 'öz', 'gəl', 'birlikdə', 'vermək', 'amma', 'sonra', 'qədər', 'yer', 'çox', 'insanlar', 'yox', 'hər ', 'istəmək', 'il', 'çıxmaq', 'görmək', 'gün', 'biz', 'getmək', 'işləmək', 'şey', 'oyun', 'bilmək', 'əl ', 'zaman', 'ya', 'uşaq', 'iki', 'bax', 'iş', 'in', 'böyük', 'yox', 'başlanğıc', 'yol', 'qal', 'niyə', 'sən ', 'mövzu', 'edilməli', 'yaxşı', 'qadın', 'ev', 'ov', 'olmaq', 'demək', 'göz', 'lazımdır', 'dünya', 'yemək', 'heç', 'hətta', 'necə', 'hamısı', 'əleyhinə', 'tapmaq', 'belə', 'yaşamaq', 'düşünmək', 'eyni', 'içmək', 'lakin', 'şəxs', 'onlar', 'birinci', 'görə', 'ön', 'son', 'bir', 'forma', 'vacib', 'üz', 'hər', 'ikisi', 'göstərmək', 'etmək', 'alt', 'gətir', 'istifadə', 'çünki', 'yan', 'indi', 'kişi', 'onun', 'başqası', 'indi', 'on', 'səs', 'həmişə ', 'sağ', 'durmaq', 'qız', 'hamısı', 'cəlb', 'etmək', 'danışmaq', 'pul', 'anlamaq', 'ana', 'az', 'bəzi', 'ata', 'həyat ',
  'yalnız', 'kiçik', 'daha', 'məlumat', 'an', 'soruş',  'yenidən', 'təmin', 'nəticə', 'istifadə', 'xarici ', 'ad', 'o', 'müddət', 'döndürmək', 'yanmaq', 'oturmaq', 'demək', 'çıxmaq', 'dərhal', 'vaxt', 'yaş', 'problem', ' dövlət ',
  ...
  'heç', 'kim', 'çox', 'deyil', 'əgər', 'lazımdır', 'xüsusən', 'məna', 'yüksək', 'bank', 'bir', 'dəfə', 'ayaq', 'hərəkət', 'geri', ' cəmiyyət', 'alət', 'element', 'növ', 'qərar', 'bax', 'hava', 'nömrə', 'fərqli', 'qrup', 'otaq', 'forma', 'forma', 'xəbərlər ', 'allah', 'həmçinin', 'gələn', 'az', 'sual', 'geri', 'qazanma', 'poçt', 'məktəb', 'açıq', 'öyrən', 'sürüş', 'dil', 'şirkət', 'mənbə', 'bitir', 'proqram', 'davam', 'hərəkət', 'rəng', 'açmaq', 'sağ', 'inan', 'təhsil', 'bucaq', 'parça', 'qəzet', 'tərtib et', 'əlbəttə', 'dəyər', 'bilmək', 'struktur', 'doktor', 'gəlir', 'tapşırıq', 'məqsəd', 'region', 'film', 'to', 'müştəri', 'artıq', 'telefon', 'təhsil', 'dəniz', 'ikinci',
